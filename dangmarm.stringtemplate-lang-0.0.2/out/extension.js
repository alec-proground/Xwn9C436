...
function activate(context) {
    ...
    function updateDecorations() {
        ...
        decorators.forEach((value) => {
            activeEditor === null || activeEditor === void 0 ? void 0 : activeEditor.setDecorations(value.decoratorType, value.conditionalCodeLines);
        });
    }
    function getDecorator(level) {
        if (!cacheDecorators.has(level)) {
            cacheDecorators.set(level, vscode.window.createTextEditorDecorationType({
                dark: {
                    before: {
